...
USE_AVX512=$avx512"
  ...
  # OPT for autotools (the wrapper adds SIMD); full set (OPT+SIMD) for CMake,
  # which is fed raw clang and so must carry the arch flags itself.
  local AUTOTOOLS_CFLAGS="$OPT_FLAGS -pipe"
